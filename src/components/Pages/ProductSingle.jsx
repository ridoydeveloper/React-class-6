...
import single1 from '../../--assets/images/shop/single-1.jpg';
import single2 from '../../--assets/images/shop/single-2.jpg';
import single3 from '../../--assets/images/shop/single-3.jpg';
import single4 from '../../--assets/images/shop/single-4.jpg';
        ...
        <div className="row">
          ...
          <div className="col-md-5 col-md-offset-1">
            <div className="title mt-0">
              <h2>Notch Blazer in Longline<span className="red-dot" /></h2>
            ...
            <div className="single-product-price">
              <div className="row">
                ...
                <div className="col-xs-6 text-right"><span className="rating-stars">              <i className="ti-star full" /><i className="ti-star full" /><i className="ti-star full" /><i className="ti-star full" /><i className="ti-star" /><span className="hidden-xs">(3 Reviews)</span></span>
                </div>
              </div>
            </div>
            ...
            <div className="single-product-add">
              <form action="#" className="inline-form">
                <div className="input-group">
                  <input type="number" placeholder="QTY" defaultValue={1} min={1} className="form-control" /><span className="input-group-btn"><button type="button" className="btn btn-color">Add to Cart<i className="ti-bag" /></button></span>
                </div>
              </form>
            </div>
          ...
          <div id="third-tab" role="tabpanel" className="tab-pane">
            <div id="comments">
              <ul className="comments-list">
                <li className="rating">
                  <h5 className="upper">Jesse Pinkman - <span className="rating-stars"><i className="ti-star full" /><i className="ti-star full" /><i className="ti-star full" /><i className="ti-star full" /><i className="ti-star" /></span></h5><span className="comment-date">Posted on 29 September at 10:41</span>
                ...
                <li className="rating">
                  <h5 className="upper">Rust Cohle - <span className="rating-stars"><i className="ti-star full" /><i className="ti-star full" /><i className="ti-star full" /><i className="ti-star full" /><i className="ti-star" /></span></h5><span className="comment-date">Posted on 29 September at 10:41</span>
                ...
                <li className="rating">
                  <h5 className="upper">Arya Stark - <span className="rating-stars"><i className="ti-star full" /><i className="ti-star full" /><i className="ti-star full" /><i className="ti-star full" /><i className="ti-star full" /></span></h5><span className="comment-date">Posted on 29 September at 10:41</span>
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quasi aspernatur vero dolorum asperiores ratione obcaecati atque quidem aliquid dicta illo, quod, similique suscipit maiores, aperiam expedita cum. Ut fugiat, dolores.</p>
                </li>
              </ul>
            </div>
            <div id="respond">
              ...
              <div className="comment-respond">
                <form className="comment-form">
                  ...
                  <div className="form-group">
                    <textarea placeholder="Comment" className="form-control" defaultValue={""} />
                  </div>
