        ...
        <div className="container">
          ...
          <div className="menu-extras">
            <div className="menu-item">
              ...
              <div className="cart">
                <a href="#">
                  <i className="ti-bag" /><span className="cart-number">2</span>
                </a>
                ...
                <div className="search-form">
                  <form action="#" className="inline-form">
                    <div className="input-group">
                      <input type="text" placeholder="Search" className="form-control" /><span className="input-group-btn"><button type="button" className="btn btn-color"><span><i className="ti-search" /></span>
                        </button>
                      </span>
                    </div>
                  </form>
