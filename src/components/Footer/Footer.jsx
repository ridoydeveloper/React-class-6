  ...
  return (
    <>
       <section className="page-title parallax">
        <div data-parallax="scroll" data-image-src="images/bg/19.jpg" className="parallax-bg" />
              ...
              <div className="row">
                <div className="col-md-4">
                  <div className="copy-text">
                    <p><i className="icon-heart red mr-15" />© 2015 Comet Agency.</p>
                  </div>
                </div>
                <div className="col-md-4">
                ...
                <div className="col-md-4">
                  <div className="footer-social">
                    <ul>
                      <li>
                        <a target="_blank" href="#"><i className="ti-facebook" /></a>
                      </li>
                      <li>
                        <a target="_blank" href="#"><i className="ti-twitter-alt" /></a>
                      </li>
                      <li>
                        <a target="_blank" href="#"><i className="ti-linkedin" /></a>
                      </li>
                      <li>
                        <a target="_blank" href="#"><i className="ti-instagram" /></a>
                      </li>
                      <li>
                        <a target="_blank" href="#"><i className="ti-dribbble" /></a>
                      </li>
                    </ul>
                  </div>
                </div>
